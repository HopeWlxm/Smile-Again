<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="/images/4.jpg" alt="User Image">
        <div>
            <p class="app-sidebar__user-name">Zhang Cheng Oba</p>
    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="/admin/form-components"><i class="icon fa fa-circle-o"></i> Form Components</a>
                </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="/admin/table-data-table"><i class="icon fa fa-circle-o"></i> Data Tables</a>
                </li>
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="/admin/blank-page"><i class="icon fa fa-circle-o"></i> Blank Page</a></li>
                <li><a class="treeview-item" href="/admin/page-login"><i class="icon fa fa-circle-o"></i> Login Page</a></li>
                <li><a class="treeview-item" href="/admin/page-lockscreen"><i class="icon fa fa-circle-o"></i> Lockscreen Page</a>
                </li>
                <li><a class="treeview-item" href="/admin/page-user"><i class="icon fa fa-circle-o"></i> User Page</a></li>
                <li><a class="treeview-item" href="/admin/page-invoice"><i class="icon fa fa-circle-o"></i> Invoice Page</a>
                </li>
                <li><a class="treeview-item" href="/admin/page-calendar"><i class="icon fa fa-circle-o"></i> Calendar Page</a>
                </li>
                <li><a class="treeview-item" href="/admin/page-mailbox"><i class="icon fa fa-circle-o"></i> Mailbox</a></li>
                <li><a class="treeview-item" href="/admin/page-error"><i class="icon fa fa-circle-o"></i> Error Page</a></li>
            </ul>
        </li>
    </ul>
</aside>