...
import com.lx.shiro.po.ActiveUser;
...
public class SysUserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        try {
            sysUser = userService.querySysUserByUserCode(username);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            menus = userService.queryMenuListByUserId(sysUser.getUserid().toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        try {
            list = userService.findPermissionListByUserId(activeUser.getUserId().toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
